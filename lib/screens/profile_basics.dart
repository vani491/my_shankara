  ...
  class _ProfileBasicsPageState extends State<ProfileBasicsPage> {
    ...
    void deleteUnverifiedAccount() {
      showDialog<void>(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            title: const Text('This will delete your unverified account. You will need to sign up again.'),
    ...
    void _showAgeGatePopup() {
      showDialog<void>(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            title: const Text('MyShankara is for seekers 18 years and older. You won’t be able to continue.'),
            actionsAlignment: MainAxisAlignment.spaceBetween,
            actions: <Widget>[
              TextButton(
